...
class Offer < ApplicationRecord
  ...
  has_many :bundles, through: :bundle_offers, source: :offer, dependent: :destroy
  ...
  def bundled_offers_correct
    if !internal?
      ...
      errors.add(:bundled_connected_offers, "only non-bundled offer can have bundled offers")
    else
      ...
      unless bundled_connected_offers.all?(&:internal?)
        errors.add(:bundled_connected_offers, "all bundled offers must be internal")
      end
